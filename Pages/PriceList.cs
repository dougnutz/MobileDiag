...
public partial class IndexModel : PageModel
{
    public static List<price> Prices =  new List<price>{
       ...
       new price("Program GM","$190","Does not include Used Global A GM PCM’s or any other used module that requires EEprom programming."),
       ...
       new price("Program Ford","$190","Does not include BCM’s"),
       new price("Program Ford BCM","$215"),
       new price("Program Chrysler","$190"),
       ...
       new price("Standard Diagnostics","$210","Includes up to 1.5 hours of diagnostic time. This covers most domestic and Asian vehicle diagnostics. Additional time is billed at $100/hr."),
       new price("European Diagnostics","$275","Includes up to 1.5 hours of diagnostic time. This covers most diagnostics. Additional time is billed at $130 per hour."),
       ...
       new price("Program Nissan","$190","For Nissan transmissions, we will provide proof of programming and proper calibration using the factory Nissan Consult III scan tool so that you have proper documentation for a warranty if you bought the transmission from a dealership."),
       new price("Program Mazda","$190"),
       new price("Program Honda","$190"),
